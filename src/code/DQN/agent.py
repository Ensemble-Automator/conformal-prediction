...
#Define constants
BUFFER_SIZE = int(250_000)  # replay buffer size
...
class Agent():
    ...
    def __init__(self, state_size=8, action_size=4, gamma=0.99, lr=LR, update_every=UPDATE_EVERY, fc1=32, fc2=32, path=None):
        """
